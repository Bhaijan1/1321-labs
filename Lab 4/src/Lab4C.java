...
public class Lab4C {
    public static void main (String []args){
        ...
        switch (choice){
            case 1: System.out.println("The Neverending Story 6\n" +
                    "Princess Diaries: the untold story\n" +
                    "Monty Python and the Programmer");
            break;
            case 2: System.out.println("All movies play at 3PM.");
            break;
            case 3: System.out.println("Corporate accounts payable, Nina speaking.\n" +
                    "Just a moment!");
            break;
            default:
